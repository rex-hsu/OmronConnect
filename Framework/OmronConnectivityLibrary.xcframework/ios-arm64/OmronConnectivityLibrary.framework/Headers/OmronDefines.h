...
extern NSString * const OMRONWeightBMILevelClassificationKey;                  // BMI Level Classification Key
...
extern NSString * const OMRONWheezeKey;                                        // Wheeze Key [1: Detected, 0: Not detected, 2: Measurement error]
...
extern NSString * const OMRONTemperatureAccurateCelsiusKey;                    // Temperature accurate value in Celsius Key
...
extern NSString * const OMRONDevicePersonalSettingsUserHeightExponentKey; // User Height Exponent
extern NSString * const OMRONDevicePersonalSettingsUserWeightExponentKey; // User Weight Exponent
extern NSString * const OMRONDevicePersonalSettingsUserStrideExponentKey; // User Stride Exponent
...
extern NSString * const OMRONDeviceInformationBatteryRemainingKey;  // Device Battery Remaining
extern NSString * const OMRONDeviceInformationUnsentDataNumKey;     // Device UnsentData Num for Selected User
...
extern NSString * const OMRONBLEConfigDeviceGroupIncludedGroupSubIDKey;     // Device Model Type Sub ID
...
extern NSString * const OMRONBLEConfigDeviceParentIDKey;                    // Device Parent Identifier
